...
{
    /// <summary>
    /// Configures the swagger settings.
    /// </summary>
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        c.IncludeXmlComments(Path.Combine(binFolder, "Dragons.Core.xml"));
                        c.IncludeXmlComments(Path.Combine(binFolder, "Dragons.Service.xml"));
